...
import no.audunfo.fromhereapp.api.instagram.model.media.ImageInfo;
import no.audunfo.fromhereapp.api.instagram.model.media.ImageType;
import no.audunfo.fromhereapp.api.instagram.model.media.Media;

/**
 * View holder for {@link no.audunfo.fromhereapp.api.instagram.model.media.Media} content.
 *
